...
const AddEditProduct = () => {
  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      const res = await axios.get(`http://192.168.0.101:8000/product/${id}`, {
      ...
      setForm({
        ...
        image: null,
        preview: `http://192.168.0.101:8000${res.data.image}`,
      });
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isEdit) {
        await axios.put(`http://192.168.0.101:8000/product/${id}`, data, {
          headers: {
        ...
        await axios.post("http://192.168.0.101:8000/product", data, {
          headers: { Authorization: `Bearer ${token}` },
        });
