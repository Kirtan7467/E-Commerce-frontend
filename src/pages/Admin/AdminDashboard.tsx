...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const productRes = await axios.get('http://192.168.0.101:8000/product');
        const bannerRes = await axios.get('http://192.168.0.101:8000/banner');
        setProductCount(productRes.data.products.length);
        const vendorRes = await axios.get('http://192.168.0.101:8000/vendor',
